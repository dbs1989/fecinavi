				...
				<tbody>	
					...
					<tr>
						...
						<td class="actions text-left">								
							...
							<button type="submit" class="btn btn-success" name="projeto['id_projeto']" value="<?php echo $projeto['id_projeto']; ?>">Avaliar</button>					

						<?php } else if($projeto['num_aval']==1) {   ?>	
							<button type="submit" class="btn btn-warning" name="projeto['id_projeto']" value="<?php echo $projeto['id_projeto']; ?>">Avaliar</button>					

						<?php } else if($projeto['num_aval']==2) {   ?>	
							<button type="submit" class="btn btn-danger" name="projeto['id_projeto']" value="<?php echo $projeto['id_projeto']; ?>">Avaliar</button>					

						<?php } else if($totalAval['total'] == $totalAval['projeto']  && $projeto['num_aval']<5) {   ?>
							<button type="submit" class="btn btn-default" name="projeto['id_projeto']" value="<?php echo $projeto['id_projeto']; ?>">Avaliar</button>				

						<?php } else {   ?>
							<span  class="bg-default text-black" name="projeto['id_projeto']" value="<?php echo $projeto['id_projeto']; ?>">Inabilitado</span>					
